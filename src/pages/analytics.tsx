...
import { RecentPatients } from "@/components/analytics/recent-patients"
...
import { VisitFrequency } from "@/components/analytics/visit-frequency"
      ...
      <Tabs defaultValue="overview" className="space-y-4">
        ...
        <TabsContent value="overview" className="space-y-4">
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
            <Card className="col-span-4">
              <CardHeader>
                <CardTitle>Peak Hours & Wait Times</CardTitle>
              </CardHeader>
              <CardContent>
                <VisitFrequency />
              </CardContent>
